...
public class HeapPriorityQueue 
{
    ...
    public void downHeap() 
    {
        ...
        while (hasLeft(index)) 
        {
            ...
            if (hasRight(index) && _pQueueArray[leftIndex(index)].getWeight() > _pQueueArray[rightIndex(index)].getWeight()) 
            {
            	smallerChild = rightIndex(index);
            } 
            if (_pQueueArray[index].getWeight() > _pQueueArray[smallerChild].getWeight()) 
            {
    ...
    {
        int index = _size;
        while (hasParent(index) && parent(index).getWeight() > _pQueueArray[index].getWeight()) 
        {
